  ...
  return(
    ...
    <div className="contact-div">
      ...
      <div className="icon-div">
        <a href="https://github.com/derricklai33"  target="_blank" rel="noreferrer">
            <i className="fab fa-github"></i>
          </a>
          <a href="https://linkedin.com/in/derrick-laijy/"  target="_blank" rel="noreferrer">
            <i className="fab fa-linkedin"></i>
          </a>
          <a href="https://twitter.com/cout_Derrick" target="_blank" rel="noreferrer">
